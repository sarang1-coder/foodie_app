    ...
    <>
      ...
      <MainBox>
        <HeaderBox>
          ...
          <IconContainer>
            <a href="#"> <InstagramIcon sx={{cursor:'pointer', color: '	black',  }} /></a>
            <a href="#"><GitHubIcon sx={{cursor:'pointer', color:'	black'}} /></a>
            <a href="#"><LinkedInIcon sx={{ cursor: 'pointer', color: '	black' }} /></a>
            <a href="mailto:sarang15mar@gmail.com"><MailOutlineIcon sx={{ cursor: 'pointer', color: 'black' }}/></a>
          </IconContainer>
        </HeaderBox>
      </MainBox>
    </>
