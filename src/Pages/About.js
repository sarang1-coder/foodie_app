      ...
      <MainContainer>
        ...
        <HeaderBox>
          ...
          <Container>
            ...
            <IconContainer>
              <a href="#"> <InstagramIcon sx={{cursor:'pointer', color: 'rgb(211,47,47)'}} /></a>
              <a href="#"><GitHubIcon sx={{cursor:'pointer', color:'black'}} /></a>
              <a href="#"><LinkedInIcon sx={{ cursor: 'pointer', color: '#0A66C2' }} /></a>
              <a href="mailto:sarang15mar@gmail.com"><MailOutlineIcon sx={{ cursor: 'pointer', color: 'red' }}/></a>
            </IconContainer>
          </Container>
        </HeaderBox>
      </MainContainer>
